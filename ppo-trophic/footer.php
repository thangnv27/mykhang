<?php get_template_part('template', 'user'); ?>
    ...
    <div class="container">
        <div class="main-footer row">
            <div class="col-xs-6 col-md-3 cotfooter">
                ...
                <p><span class="glyphicon glyphicon-home"></span> Kho hàng: <?php echo get_option('info_address_kho'); ?></p>
                <p><span class="glyphicon glyphicon-home"></span> Nơi sản xuất: <?php echo get_option('info_address_sx'); ?></p>
