            ...
            <div class="top-menu pdt5">
                <div class="left-user">
                    ...
                    <ul class="menu-user">
                        ...
                        $delivery = get_option(SHORT_NAME . "_delivery");
                        $cart = get_option(SHORT_NAME . "_cart");
                        ?>
                        <li class="hidden-xs">
                            <a title="Chính sách Giao hàng" href="<?php echo get_page_link($delivery); ?>">Chính sách Giao hàng</a>
                        </li>
                        <li class="hidden-xs">
                            <a title="Hướng dẫn mua hàng" href="<?php echo get_page_link($cart); ?>">Hướng dẫn mua hàng</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3 side-cat-menu">
                    <div class="cat-menu-title">
                        <p class="danhmucmenu">Danh mục - MENU</p>
                    </div>
                    <div class="menu-cat">
