<div class="module_tintuc_khachhang">
    <h4 class="tieudenewsf">
        ...
        ?>
        <a href="<?php echo get_category_link($categoryhome); ?>" title="<?php echo $categoryuser->name; ?>"><span class="glyphicon glyphicon-credit-card"></span> <?php echo $categoryuser->name; ?></a>
